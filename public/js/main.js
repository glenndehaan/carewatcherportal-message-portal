            ...
            <div class="card hoverable">
                <div class="card ${expressConfig.stringsHelper.getColorBasedOnPrio(message.prio)} accent-2">
                    <div class="card-content white-text">
                        <div class="iconbox">
                            <div class="left"><i class="material-icons">${expressConfig.stringsHelper.getIconOnPrio(message.prio)}</i>&nbsp;</div>
                            <div class="right"><input type="checkbox" class="completed-checkbox" id='${message._id}' data-id="${message._id}" data-completed="${message.completed}" ${message.completed ? 'checked="checked" disabled' : ''} /> <label for='${message._id}' class="white-text" >Done</label></div>
                        </div>
